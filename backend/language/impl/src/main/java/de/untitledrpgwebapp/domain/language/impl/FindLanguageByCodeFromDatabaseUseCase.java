...
public class FindLanguageByCodeFromDatabaseUseCase implements FindLanguageByCodeUseCase {

  private final LanguageRepository languageRepository;

  public FindLanguageByCodeFromDatabaseUseCase(LanguageRepository languageRepository) {
