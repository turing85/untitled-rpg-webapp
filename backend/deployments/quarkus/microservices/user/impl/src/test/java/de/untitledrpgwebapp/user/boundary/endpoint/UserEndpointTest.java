...
import static de.untitledrpgwebapp.common.testfixture.PageConfigDtoFixture.PAGE_CONFIG_DTO;
...
import de.untitledrpgwebapp.user.boundary.mapper.DeploymentUserMapper;
...
class UserEndpointTest {
  ...
  private final FindAllUsersUseCase findAllUsers = mock(FindAllUsersUseCase.class);
  private final FindUserByNameUseCase findUser = mock(FindUserByNameUseCase.class);
  private final CreateUserUseCase createUser = mock(CreateUserUseCase.class);
  private final DeploymentUserMapper mapper = mock(DeploymentUserMapper.class);

  private final UserEndpoint uut = new UserEndpoint(findAllUsers, findUser, createUser, mapper);
